...
export default function LecturePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="flex-1 p-4 md:p-12 lg:p-16 w-full overflow-x-hidden">
      <div className="fixed top-16 left-0 right-0 h-1 bg-primary/20 z-[60]">
        <motion.div
      ...
      <div className="max-w-6xl mx-auto space-y-8 pb-20">
          ...
          <div className="flex gap-2 border-b pb-px overflow-x-auto no-scrollbar sticky top-16 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-md z-40 pt-2">
